...
export default class InsertCuestionario extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            value: 50,
...
causa del dolor? </Label>
            ...
            <Button onClick={this.registrarCuestionario} type="button" className="btn btn-md btn-block" style={{ backgroundColor: "#C9D468", fontWeight: "bold", borderBottomWidth: 3, borderColor: "green" }}>{this.state.textButton}</Button>
                    </div>
                </Row>
            </Container>
            </Dialog>
