...
export default function MenuDoctor(props) {
  const { window } = props;
  ...
  const drawer = (
    <div>
      ...
      <ListItem className={"link"} component={Link} to={"/inicioDoctor"} style={{backgroundColor:props.activo===1?"#C9D468":""}}>
          <ListItemIcon>
            <HomeIcon></HomeIcon>
          </ListItemIcon>
        ...
        <ListItem className={"link"} component={Link} to={"/pacientes"} style={{backgroundColor:props.activo===2?"#C9D468":""}}>
          <ListItemIcon>
